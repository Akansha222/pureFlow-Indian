...
export class ComplaintsComponent implements OnInit {
  ...
  constructor(public db: DatabaseService,public route:ActivatedRoute, public dialog: DialogComponent , public alrt:MatDialog ) {
  ...
  {
    this.filter.mode = 1;
    this.db.post_rqst(  {'filter': this.filter , 'login':this.db.datauser}, 'karigar/exportComplaint')
    .subscribe( d => {
